-- Acessando o banco de dados bd_empresa, as consultas SQL ficaram assim:

-- Consulta 01. Gerar a lista de aniversariantes da empresa com mês, dia e nome do empregado ordem cronológica.
...
-- Consulta 02. Listar os departamentos e seus gerentes com tempo de gerência em anos ordenando pelo mais antigo.
-- Opção 1
SELECT nom_depto, 
       nom_empregado, 
...
-- Consulta 03. Listar os funcionários  que terão mais que 65 a partir de 2021.
-- Opção 1
